...
namespace Test.Data
{
	...
	///++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	/// </history>
	public class PharmClass : BaseData
	{
		#region Variables
		...
		/// <summary>
		/// Gets/Sets the PharmClassUID property.
		/// </summary>
		[ColumnProperty(ColumnName = "PharmClassUID")]
		public long PharmClassUID
		{
			get { return _pharmClassUID; }
			set { _pharmClassUID = value; }
		}
		...
		/// <inheritdoc/>
		public PharmClass() : base() { }

		/// <inheritdoc/>
		public PharmClass(string dbServer, string dbDatabase, string dbUsername, string dbPassword) : base(dbServer, dbDatabase, dbUsername, dbPassword) { }

		/// <inheritdoc/>
		public PharmClass(string dbServer, string dbDatabase, string dbUsername, string dbPassword, int commandTimeout) : base(dbServer, dbDatabase, dbUsername, dbPassword, commandTimeout) { }

		/// <summary>
		/// Initializes a new instance of the PharmClass class.
		/// </summary>
		...
		public PharmClass(string dbServer, string dbDatabase, string dbUsername, string dbPassword, long drugUID, string name, string createdMachine, string createdApp, DateTime createdDate, string createdBy, string updatedMachine, string updatedApp, DateTime updatedDate, string updatedBy) : base(dbServer, dbDatabase, dbUsername, dbPassword)
		{
			_drugUID = drugUID;
			_name = name;
		...
		/// <summary>
		/// Returns the record for the specified PharmClassUID from the database.
		/// </summary>
		/// <history>
		///++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		/// Date		Author					Description
		...
		///++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		/// </history>
		public bool Find(long pharmClassUID)
		{
			try {
				return base.Find(pharmClassUID);
			}
			catch (Exception) {
				throw;
			}
		...
		protected override void SetupDatabase()
		{
			...
			_cspAdd = "csp_PharmClass_Add";
			_cspUpdate = "csp_PharmClass_Update";
			_cspFind = "csp_PharmClass_Find";
			_cspDelete = "csp_PharmClass_Delete";
		}
	...
	public class PharmClasses : BaseDataCollection<PharmClass>
	{
		#region Variables
		...
		public PharmClasses(string dbServer, string dbDatabase, string dbUsername, string dbPassword) : base(dbServer, dbDatabase, dbUsername, dbPassword)
		{
			_SetupDatabase();
		}
		...
		{
			return Find(drugUID, false);
		}

		public bool Find(long drugUID, bool deleted)
		{
			return base.Find(drugUID, deleted);
		}
		...
		{
			_cspFind = "csp_PharmClasses_Find";
			_cspFindParameterNames.Clear();
			_cspFindParameterNames.Add("DrugUID");
		}
